...
struct Texture
{
    ...
    void loadImage(std::string_view path, GLint texMode = GL_MIRRORED_REPEAT, bool flip = false);
    void loadBMP(std::string_view path, GLint texMode = GL_MIRRORED_REPEAT);
    void use();
